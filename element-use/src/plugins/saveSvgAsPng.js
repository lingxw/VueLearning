(function() {
  const out$ = typeof exports != 'undefined' && exports || typeof window.define != 'undefined' && {} || this || window;
  if (typeof window.define !== 'undefined') window.define('save-svg-as-png', [], () => out$);
  ...
  out$.svgAsPngUri = (el, options, done) => {
    ...
    const convertToPng = ({src, width, height}) => {
      ...
      try {
        ...
        if ((typeof window.SecurityError !== 'undefined' && e instanceof window.SecurityError) || e.name === 'SecurityError') {
